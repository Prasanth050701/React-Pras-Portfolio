            ...
            <div className='heading'>
                ...
                <div className='row'>
                    ...
                    <div className='col-sm-12'>
                        ...
                        The design of this project is very simple so that the user won't find any difficulties while working on it
                         ...
                         <h2 className='myskills'>Project Domain and Tools</h2>
                         <br />
                         <p className='skills'>
                           This application is developed by the following programming and tools
                         </p>
                         <ul>
              ...
              <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-sm-12'>
                         <h2 className='myskills' style={{ textAlign: 'justify'}}>
                            Web Application for Travel and Tourism
                            </h2>
                         <div>
                            <div className='embed-responsive embed-responsive-16by9'>
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/Ul3y1LXxzdU" title="YouTube video player"
                        ...
                        The design of this project is very simple so that the user won't find any difficulties while working on it
                         ...
                         <ul>
                            <li>Frontend - HTML,CSS,JAVASCRIPT,ANGULAR,TYPESCRIPT,BOOTSTARP</li>
                ...
                <div className='row'>
                    ...
                    <div className='col-sm-12'>
                        ...
                        The design of this project is very simple so that the user won't find any difficulties while working on it
                         ...
                         <ul>
                            <li>Frontend - HTML,CSS,JAVASCRIPT,REACT JS,BOOTSTARP</li>
                            <li>Backend -NODE JS</li>
                            <li>Dtabase - MYSQL</li>
                         </ul>
                         <div>
